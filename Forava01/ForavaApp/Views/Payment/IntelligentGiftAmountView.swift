            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    CustomAmountSection(
                        ...
                        showingCustomInput: $showingCustomInput,
                        selectedAmount: $selectedAmount,
                        onAmountChange: validateAndSetCustomAmount
                    )
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Created \(rakhi.createdAt, style: .relative)")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
...
struct CustomAmountSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            SectionHeader(
                title: "Custom Amount",
                subtitle: "Enter your preferred amount",
            ...
            if showingCustomInput {
                HStack {
                    ...
                    TextField("Enter amount", text: $customAmount)
                        ...
                        .onChange(of: customAmount, perform: onAmountChange)
