...
# Files to add
new_files = [
    ("ForavaApp/Models/RakhiModel.swift", "RakhiModel.swift"),
    ("ForavaApp/Views/ContactSelectionView.swift", "ContactSelectionView.swift"),
    ("ForavaApp/Views/RakhiSelectionView.swift", "RakhiSelectionView.swift"),
    ("ForavaApp/Views/PaymentReceiveView.swift", "PaymentReceiveView.swift"),
    ("ForavaApp/Services/WatchConnectivityManager.swift", "WatchConnectivityManager.swift"),
]
...
print("Successfully added new files to Xcode project!")
print("Files added:")
for file_path, file_name in new_files:
    print(f"  - {file_name}")