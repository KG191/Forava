...
struct GenreSelectionStep: View {
    ...
    private func updateElementsForGenre(_ genre: RakhiGenre) {
        // Mock implementation - just clear elements for now
        designSpec.elements = []
...
struct SelectedGenreDescription: View {
    ...
    private func getDetailedDescription(for genre: RakhiGenre) -> String {
        switch genre {
        case .traditional:
            return "Traditional Rakhis honor centuries-old customs with sacred red threads (mauli), " +
                   "gold beads, and time-honored symbols. Perfect for celebrating the classic " +
                   "brother-sister bond with authenticity and cultural significance."
        case .modern:
            return "Modern Rakhis blend contemporary aesthetics with traditional meaning. " +
                   "Featuring innovative materials, geometric patterns, and fresh color " +
                   "combinations while maintaining the essence of Raksha Bandhan."
        case .elegant:
            return "Elegant Rakhis showcase sophisticated craftsmanship with premium materials " +
                   "like pearls, crystals, and refined metalwork. Ideal for expressing " +
                   "appreciation through tasteful luxury and refined beauty."
        case .spiritual:
            return "Spiritual Rakhis incorporate sacred symbols like Om, lotus, and rudraksha " +
                   "beads to create a deeper connection with divine blessings. Perfect for " +
                   "honoring the spiritual aspects of the festival."
        case .unknown:
            return ""
        }
    }
