...
class PerformanceOptimizer: ObservableObject {
    ...
    private func handleMemoryWarning() {
        ...
        AIRakhiService.shared.clearGenerationCache()
        AdvancedAnimationService.shared.clearAnimationCache()
    ...
    private func assessDeviceCapabilities() -> DevicePerformanceCapabilities {
    ...
    private func getAverageAIGenerationTime() -> Double {
        return AIRakhiService.shared.averageGenerationTime
    }

    private func getAnimationFrameRate() -> Double {
        return AdvancedAnimationService.shared.currentFrameRate
    }
