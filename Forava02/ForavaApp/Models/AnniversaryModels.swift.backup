...
// MARK: - Anniversary Selection State
struct AnniversarySelectionState: Codable {
    var selectedTheme: AnniversaryTheme?
    var selectedGift: String?
    var selectedElements: [AnniversaryElement] = []
    var selectedColorPalette: AnniversaryColorPalette?
    var selectedOptionalMessage: AnniversaryPersonalTouch?
