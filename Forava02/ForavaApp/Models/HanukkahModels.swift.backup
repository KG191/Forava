...
// MARK: - Hanukkah Selection State
struct HanukkahSelectionState: Codable {
    var selectedTheme: HanukkahTheme?
    var selectedGift: String?
    var selectedElements: [HanukkahElement] = []
    var selectedColorPalette: HanukkahColorPalette?
    var selectedOptionalMessage: HanukkahPersonalTouch?
