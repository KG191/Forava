...
// MARK: - Rosh Hashanah Selection State
struct RoshHashanahSelectionState: Codable {
    var selectedTheme: RoshHashanahTheme?
    var selectedGift: String?
    var selectedElements: [RoshHashanahElement] = []
    var selectedColorPalette: RoshHashanahColorPalette?
    var selectedOptionalMessage: RoshHashanahPersonalTouch?
