...
// MARK: - Holi Theme Structure
enum HoliTheme: String, Codable, CaseIterable {
    ...
    var description: String {
        switch self {
        case .traditional:
            return "Classic Holi with authentic diyas and traditional rangoli patterns, sacred religious elements, timeless festive atmosphere, heritage visualization, traditional पारंपरिक aesthetics"
        case .modern:
            return "Contemporary Holi with sleek modern aesthetics, minimalist design patterns, sophisticated urban festival vibe, clean contemporary lines, stylish आधुनिक elegance, innovative cultural fusion"
...
// MARK: - Holi Design Elements
struct HoliElement: Identifiable, Codable {
    let id: UUID
    let name: String
...
// MARK: - Holi Elements Collection
extension HoliElement {
    static let allElements: [HoliElement] = [
        ...
        HoliElement(
            ...
            hindiName: "पटाखे",
            weight: 2.2,
            aiPromptModifier: "(spectacular fireworks display:2.2), colorful celebration lights in night sky, festive sparklers, joyous Holi celebration atmosphere"
        )
    ]
}

// MARK: - Holi Color Palettes
struct HoliColorPalette: Identifiable, Codable {
    let id: UUID
    let name: String
    let hindiName: String
...
// MARK: - Holi Color Palettes Collection
extension HoliColorPalette {
    static let allPalettes: [HoliColorPalette] = [
        HoliColorPalette(
            name: "Classic Holi",
...
// MARK: - Holi Personal Touch Messages
struct HoliPersonalTouch: Identifiable, Codable {
    let id: UUID
    let message: String
...
// MARK: - Holi Personal Touch Collection
extension HoliPersonalTouch {
    static let optionalMessages: [HoliPersonalTouch] = [
        HoliPersonalTouch(
        ...
        HoliPersonalTouch(
            message: "Happy Holi! May joy fill your heart",
        ...
        HoliPersonalTouch(
            message: "Light, love, and laughter this Holi",
    ...
    static let personalMessagePlaceholder = "Add your own personal Holi message here..."
