...
// MARK: - Christmas Selection State
struct ChristmasSelectionState: Codable {
    var selectedTheme: ChristmasTheme?
    var selectedGift: String?
    var selectedElements: [ChristmasElement] = []
    var selectedColorPalette: ChristmasColorPalette?
    var selectedOptionalMessage: ChristmasPersonalTouch?
