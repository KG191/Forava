...
// MARK: - Raksha Bandhan Selection State
struct RakshaBandhanSelectionState: Codable {
    var selectedTheme: RakshaBandhanTheme?
    var selectedGift: String?
    var selectedElements: [RakshaBandhanElement] = []
    var selectedColorPalette: RakshaBandhanColorPalette?
    var selectedOptionalMessage: RakshaBandhanPersonalTouch?
