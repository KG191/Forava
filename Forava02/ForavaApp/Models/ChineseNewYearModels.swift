...
// MARK: - Chinese New Year Selection State
struct ChineseNewYearSelectionState: Codable {
    var selectedTheme: ChineseNewYearTheme?
    var selectedGift: String?
    var selectedElements: [ChineseNewYearElement] = []
    var selectedColorPalette: ChineseNewYearColorPalette?
    var selectedOptionalMessage: ChineseNewYearPersonalTouch?
