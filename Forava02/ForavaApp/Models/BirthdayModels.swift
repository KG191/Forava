...
// MARK: - Birthday Selection State
struct BirthdaySelectionState: Codable {
    var selectedTheme: BirthdayTheme?
    var selectedGift: String?
    var selectedElements: [BirthdayElement] = []
    var selectedColorPalette: BirthdayColorPalette?
    var selectedOptionalMessage: BirthdayPersonalTouch?
