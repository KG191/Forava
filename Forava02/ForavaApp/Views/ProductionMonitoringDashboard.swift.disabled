    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            ChartCard(
                ...
                currentValue: String(format: "%.1f", metrics.aiGenerationTime) + "s",
        ...
        VStack(spacing: 16) {
            ...
            LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 2), spacing: 12) {
                ...
                HealthMetricCard(
                    ...
                    value: String(format: "%.1f", metrics.aiGenerationTime) + "s",
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    DetailedMetricSection(title: "AI Performance", metrics: [
                        ("Generation Time", String(format: "%.1f", metrics.aiGenerationTime) + "s"),
                        ("Model", "SDXL"),
