...
struct ChineseNewYearElementsSelectionView: View {
    @Binding var selectedElements: [ChineseNewYearElement]
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        LazyVGrid(columns: columns, spacing: 12) {
                            ForEach(ChineseNewYearElement.allElements) { element in
                                elementCard(
                                    element: element,
    ...
    private func toggleElementSelection(_ element: ChineseNewYearElement) {
...
#Preview {
    ChineseNewYearElementsSelectionView(
        selectedElements: .constant([ChineseNewYearElement.allElements[0]]),
