...
struct ChineseNewYearColorPaletteView: View {
    @Binding var selectedColorPalette: ChineseNewYearColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Chinese New Year celebration")
                ...
                VStack(spacing: 20) {
                    LazyVGrid(columns: columns, spacing: 16) {
                        ForEach(ChineseNewYearColorPalette.allPalettes) { palette in
                            colorPaletteCard(
                                palette: palette,
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: ChineseNewYearColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: ChineseNewYearColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    ChineseNewYearColorPaletteView(
        selectedColorPalette: .constant(ChineseNewYearColorPalette.allPalettes[0]),
