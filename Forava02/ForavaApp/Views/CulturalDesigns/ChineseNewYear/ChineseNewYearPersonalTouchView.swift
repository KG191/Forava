...
struct ChineseNewYearPersonalTouchView: View {
    @Binding var selectedMessage: ChineseNewYearPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own Chinese New Year greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        ForEach(ChineseNewYearPersonalTouch.optionalMessages) { message in
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(ChineseNewYearPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: ChineseNewYearPersonalTouch) -> some View {
        Button {
...
#Preview {
    ChineseNewYearPersonalTouchView(
        selectedMessage: .constant(ChineseNewYearPersonalTouch.optionalMessages[0]),
