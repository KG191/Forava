...
struct EidAlAdhaElementsSelectionView: View {
    @Binding var selectedElements: [EidAlAdhaElement]
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        LazyVGrid(columns: columns, spacing: 12) {
                            ForEach(EidAlAdhaElement.allElements) { element in
                                elementCard(
                                    element: element,
    ...
    private func toggleElementSelection(_ element: EidAlAdhaElement) {
...
#Preview {
    EidAlAdhaElementsSelectionView(
        selectedElements: .constant([EidAlAdhaElement.allElements[0]]),
