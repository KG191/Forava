...
struct EidAlAdhaColorPaletteView: View {
    @Binding var selectedColorPalette: EidAlAdhaColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your EidAlAdha celebration")
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: EidAlAdhaColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: EidAlAdhaColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    EidAlAdhaColorPaletteView(
        selectedColorPalette: .constant(EidAlAdhaColorPalette.allPalettes[0]),
