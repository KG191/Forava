...
struct EidAlAdhaPersonalTouchView: View {
    @Binding var selectedMessage: EidAlAdhaPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own EidAlAdha greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(EidAlAdhaPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: EidAlAdhaPersonalTouch) -> some View {
        Button {
...
#Preview {
    EidAlAdhaPersonalTouchView(
        selectedMessage: .constant(EidAlAdhaPersonalTouch.optionalMessages[0]),
