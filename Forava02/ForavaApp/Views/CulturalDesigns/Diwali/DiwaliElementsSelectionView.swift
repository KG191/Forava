...
struct DiwaliElementsSelectionView: View {
    @Binding var selectedElements: [DiwaliElement]
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        LazyVGrid(columns: columns, spacing: 12) {
                            ForEach(DiwaliElement.allElements) { element in
                                elementCard(
                                    element: element,
    ...
    private func toggleElementSelection(_ element: DiwaliElement) {
...
#Preview {
    DiwaliElementsSelectionView(
        selectedElements: .constant([DiwaliElement.allElements[0]]),
