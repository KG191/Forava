...
struct DiwaliCreateSummaryView: View {
    let selectedTheme: DiwaliTheme?
    let selectedElements: [DiwaliElement]
    let selectedColorPalette: DiwaliColorPalette?
    ...
    private func generationPreview() -> some View {
        VStack(spacing: 12) {
            ...
            Text("Your personalized Diwali gift will include both iPhone and Apple Watch formats")
...
#Preview {
    DiwaliCreateSummaryView(
        ...
        selectedElements: [DiwaliElement.allElements[0]],
        selectedColorPalette: DiwaliColorPalette.allPalettes[0],
