...
struct DiwaliColorPaletteView: View {
    @Binding var selectedColorPalette: DiwaliColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Diwali celebration")
                ...
                VStack(spacing: 20) {
                    LazyVGrid(columns: columns, spacing: 16) {
                        ForEach(DiwaliColorPalette.allPalettes) { palette in
                            colorPaletteCard(
                                palette: palette,
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: DiwaliColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: DiwaliColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    DiwaliColorPaletteView(
        selectedColorPalette: .constant(DiwaliColorPalette.allPalettes[0]),
