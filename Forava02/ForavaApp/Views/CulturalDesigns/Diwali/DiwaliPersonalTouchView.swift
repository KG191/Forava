...
struct DiwaliPersonalTouchView: View {
    @Binding var selectedMessage: DiwaliPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own Diwali greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        ForEach(DiwaliPersonalTouch.optionalMessages) { message in
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(DiwaliPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: DiwaliPersonalTouch) -> some View {
        Button {
...
#Preview {
    DiwaliPersonalTouchView(
        selectedMessage: .constant(DiwaliPersonalTouch.optionalMessages[0]),
