...
struct HanukkahPersonalTouchView: View {
    @Binding var selectedMessage: HanukkahPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own Hanukkah greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        ForEach(HanukkahPersonalTouch.optionalMessages) { message in
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(HanukkahPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: HanukkahPersonalTouch) -> some View {
        Button {
...
#Preview {
    HanukkahPersonalTouchView(
        selectedMessage: .constant(HanukkahPersonalTouch.optionalMessages[0]),
