...
struct HanukkahColorPaletteView: View {
    @Binding var selectedColorPalette: HanukkahColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Hanukkah celebration")
                ...
                VStack(spacing: 20) {
                    LazyVGrid(columns: columns, spacing: 16) {
                        ForEach(HanukkahColorPalette.allPalettes) { palette in
                            colorPaletteCard(
                                palette: palette,
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: HanukkahColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: HanukkahColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    HanukkahColorPaletteView(
        selectedColorPalette: .constant(HanukkahColorPalette.allPalettes[0]),
