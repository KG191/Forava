...
struct HanukkahCheckImageView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                // Header Section
                VStack(spacing: 12) {
                    Text(isGenerating ? "Generating Your Gift..." : "Your Hanukkah Gift")
    ...
    private func generationProgress() -> some View {
        VStack(spacing: 20) {
            ...
            Text("Creating your personalized Hanukkah gift...")
        ...
        NavigationView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Generate a new variation of your Hanukkah design")
                        .font(.system(.body, design: .rounded))
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                }
    ...
    private func emptyState() -> some View {
        VStack(spacing: 16) {
            ...
            Text("Go to the Create tab to generate your Hanukkah gift")
                .font(.system(.subheadline, design: .rounded))
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
        }
...
#Preview {
    HanukkahCheckImageView(
        generatedImages: [:],
        personalMessage: "חג שמח! Happy Hanukkah and Festival of Lights!",
