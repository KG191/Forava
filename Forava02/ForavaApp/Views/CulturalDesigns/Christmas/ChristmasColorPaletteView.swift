...
struct ChristmasColorPaletteView: View {
    @Binding var selectedColorPalette: ChristmasColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Christmas celebration")
                ...
                VStack(spacing: 20) {
                    LazyVGrid(columns: columns, spacing: 16) {
                        ForEach(ChristmasColorPalette.allPalettes) { palette in
                            colorPaletteCard(
                                palette: palette,
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: ChristmasColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: ChristmasColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    ChristmasColorPaletteView(
        selectedColorPalette: .constant(ChristmasColorPalette.allPalettes[0]),
