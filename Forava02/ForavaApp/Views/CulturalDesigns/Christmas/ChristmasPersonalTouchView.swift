...
struct ChristmasPersonalTouchView: View {
    @Binding var selectedMessage: ChristmasPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own Christmas greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(ChristmasPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: ChristmasPersonalTouch) -> some View {
        Button {
...
#Preview {
    ChristmasPersonalTouchView(
        selectedMessage: .constant(ChristmasPersonalTouch.optionalMessages[0]),
