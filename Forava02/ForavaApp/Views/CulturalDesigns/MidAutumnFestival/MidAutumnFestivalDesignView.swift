...
struct MidAutumnFestivalDesignView: View, CulturalDesignViewProtocol {
    // MARK: - Protocol Requirements
    typealias CulturalTheme = MidAutumnFestivalTheme
    typealias CulturalElement = MidAutumnFestivalElement
    typealias CulturalColorPalette = MidAutumnFestivalColorPalette
    typealias CulturalPersonalTouch = MidAutumnFestivalPersonalTouch

    // MARK: - Content View Types
    typealias StyleContent = MidAutumnFestivalStyleSelectionView
    typealias ElementsContent = MidAutumnFestivalElementsSelectionView
    typealias ColorContent = MidAutumnFestivalColorPaletteView
    typealias TouchContent = MidAutumnFestivalPersonalTouchView
    ...
    @State var selectedTheme: MidAutumnFestivalTheme?
    @State var selectedElements: [MidAutumnFestivalElement] = []
    @State var selectedColorPalette: MidAutumnFestivalColorPalette?
    @State var selectedMessage: MidAutumnFestivalPersonalTouch?
    ...
    @StateObject private var midAutumnFestivalAI = MidAutumnFestivalAIService.shared
    ...
    var body: some View {
        ...
        .navigationTitle("Mid-Autumn Festival Design")
...
extension MidAutumnFestivalDesignView {
    @ViewBuilder func styleContent() -> StyleContent {
        MidAutumnFestivalStyleSelectionView(
    ...
    @ViewBuilder func elementsContent() -> ElementsContent {
        MidAutumnFestivalElementsSelectionView(
    ...
    @ViewBuilder func colorContent() -> ColorContent {
        MidAutumnFestivalColorPaletteView(
    ...
    @ViewBuilder func touchContent() -> TouchContent {
        MidAutumnFestivalPersonalTouchView(
    ...
    @ViewBuilder func createContent() -> CreateContent {
        MidAutumnFestivalCreateSummaryView(
            selectedTheme: selectedTheme,
            selectedElements: selectedElements,
            selectedColorPalette: selectedColorPalette,
    ...
    @ViewBuilder func sendContent() -> SendContent {
        MidAutumnFestivalSendShareView(
            generatedImages: generatedImages,
            personalMessage: finalMessage,
            selectedContact: selectedContact,
            culturalColor: culturalColor,
    ...
    private func generateMidAutumnFestivalGift() {
        print("🎯 Generate Mid-Autumn Festival Gift button tapped")
...
print("=" + String(repeating: "=", count: 79))
        ...
        Task {
            ...
            do {
                print("🎨 Starting Mid-Autumn Festival AI generation...")
                ...
                let iPhoneURL = try await midAutumnFestivalAI.generateMidAutumnFestivalGift(
                    theme: theme,
                ...
                let watchURL = try await midAutumnFestivalAI.generateMidAutumnFestivalGift(
                    theme: theme,
                    element: primaryElement,
                    colorPalette: colorPalette,
                    message: finalMessage,
                ...
                print("🎉 All Mid-Autumn Festival images generated successfully!")

            } catch {
                print("❌ Mid-Autumn Festival generation failed: \(error.localizedDescription)")
                await MainActor.run {
                    isGenerating = false
    ...
    private func regenerateWithCreditCheck() {
        ...
        if hasGeneratedOnce {
            ...
            if paymentService.hasRegenerationCredits() {
                ...
                let success = paymentService.useRegenerationCredit(for: "Mid Autumn Festival")
                if success {
                    print("✅ Credit used for Mid Autumn Festival regeneration")
                    generateMidAutumnFestivalGift()
                } else {
