...
struct MidAutumnFestivalPersonalTouchView: View {
    @Binding var selectedMessage: MidAutumnFestivalPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own Mid-Autumn Festival greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        ForEach(MidAutumnFestivalPersonalTouch.optionalMessages) { message in
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(MidAutumnFestivalPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: MidAutumnFestivalPersonalTouch) -> some View {
        Button {
...
#Preview {
    MidAutumnFestivalPersonalTouchView(
        selectedMessage: .constant(MidAutumnFestivalPersonalTouch.optionalMessages[0]),
