...
struct MidAutumnFestivalColorPaletteView: View {
    @Binding var selectedColorPalette: MidAutumnFestivalColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Mid-Autumn Festival celebration")
                ...
                VStack(spacing: 20) {
                    LazyVGrid(columns: columns, spacing: 16) {
                        ForEach(MidAutumnFestivalColorPalette.allPalettes) { palette in
                            colorPaletteCard(
                                palette: palette,
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: MidAutumnFestivalColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: MidAutumnFestivalColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    MidAutumnFestivalColorPaletteView(
        selectedColorPalette: .constant(MidAutumnFestivalColorPalette.allPalettes[0]),
