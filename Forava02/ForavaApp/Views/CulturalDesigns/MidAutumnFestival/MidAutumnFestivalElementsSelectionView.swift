...
struct MidAutumnFestivalElementsSelectionView: View {
    @Binding var selectedElements: [MidAutumnFestivalElement]
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        LazyVGrid(columns: columns, spacing: 12) {
                            ForEach(MidAutumnFestivalElement.allElements) { element in
                                elementCard(
                                    element: element,
    ...
    private func toggleElementSelection(_ element: MidAutumnFestivalElement) {
...
#Preview {
    MidAutumnFestivalElementsSelectionView(
        selectedElements: .constant([MidAutumnFestivalElement.allElements[0]]),
