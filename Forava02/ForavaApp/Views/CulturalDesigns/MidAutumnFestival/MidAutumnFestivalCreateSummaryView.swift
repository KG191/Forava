...
struct MidAutumnFestivalCreateSummaryView: View {
    let selectedTheme: MidAutumnFestivalTheme?
    let selectedElements: [MidAutumnFestivalElement]
    let selectedColorPalette: MidAutumnFestivalColorPalette?
    ...
    private func generationPreview() -> some View {
        VStack(spacing: 12) {
            ...
            Text("Your personalized Mid-Autumn Festival gift will include both iPhone and Apple Watch formats")
...
#Preview {
    MidAutumnFestivalCreateSummaryView(
        ...
        selectedElements: [MidAutumnFestivalElement.allElements[0]],
        selectedColorPalette: MidAutumnFestivalColorPalette.allPalettes[0],
        finalMessage: "中秋快樂! Wishing you a happy Mid-Autumn Festival",
