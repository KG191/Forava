...
struct RoshHashanahCheckImageView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                // Header Section
                VStack(spacing: 12) {
                    Text(isGenerating ? "Generating Your Gift..." : "Your Rosh Hashanah Gift")
    ...
    private func generationProgress() -> some View {
        VStack(spacing: 20) {
            ...
            Text("Creating your personalized Rosh Hashanah gift...")
    ...
    private func emptyState() -> some View {
        VStack(spacing: 16) {
            ...
            Text("Go to the Create tab to generate your Rosh Hashanah gift")
                .font(.system(.subheadline, design: .rounded))
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
        }
