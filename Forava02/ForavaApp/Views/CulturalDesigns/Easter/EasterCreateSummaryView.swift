...
struct EasterCreateSummaryView: View {
    let selectedTheme: EasterTheme?
    let selectedElements: [EasterElement]
    let selectedColorPalette: EasterColorPalette?
    ...
    private func generationPreview() -> some View {
        VStack(spacing: 12) {
            ...
            Text("Your personalized Easter gift will include both iPhone and Apple Watch formats")
...
#Preview {
    EasterCreateSummaryView(
        ...
        selectedElements: [EasterElement.allElements[0]],
        selectedColorPalette: EasterColorPalette.allPalettes[0],
        finalMessage: "Wishing you a blessed Easter filled with joy and peace",
