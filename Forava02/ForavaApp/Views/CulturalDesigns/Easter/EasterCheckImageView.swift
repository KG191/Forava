...
struct EasterCheckImageView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                // Header Section
                VStack(spacing: 12) {
                    Text(isGenerating ? "Generating Your Gift..." : "Your Easter Gift")
    ...
    private func generationProgress() -> some View {
        VStack(spacing: 20) {
            ...
            Text("Creating your personalized Easter gift...")
        ...
        NavigationView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Generate a new variation of your Easter design")
                        .font(.system(.body, design: .rounded))
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                }
    ...
    private func emptyState() -> some View {
        VStack(spacing: 16) {
            ...
            Text("Go to the Create tab to generate your Easter gift")
                .font(.system(.subheadline, design: .rounded))
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
        }
