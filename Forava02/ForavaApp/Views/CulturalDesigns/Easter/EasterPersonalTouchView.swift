...
struct EasterPersonalTouchView: View {
    @Binding var selectedMessage: EasterPersonalTouch?
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(EasterPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: EasterPersonalTouch) -> some View {
        Button {
...
#Preview {
    EasterPersonalTouchView(
        selectedMessage: .constant(EasterPersonalTouch.optionalMessages[0]),
