...
struct EasterColorPaletteView: View {
    @Binding var selectedColorPalette: EasterColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Easter celebration")
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: EasterColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: EasterColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    EasterColorPaletteView(
        selectedColorPalette: .constant(EasterColorPalette.allPalettes[0]),
