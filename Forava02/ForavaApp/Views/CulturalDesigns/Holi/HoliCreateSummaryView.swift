...
struct HoliCreateSummaryView: View {
    let selectedTheme: HoliTheme?
    let selectedElements: [HoliElement]
    let selectedColorPalette: HoliColorPalette?
    ...
    private func generationPreview() -> some View {
        VStack(spacing: 12) {
            ...
            Text("Your personalized Holi gift will include both iPhone and Apple Watch formats")
...
#Preview {
    HoliCreateSummaryView(
        ...
        selectedElements: [HoliElement.allElements[0]],
        selectedColorPalette: HoliColorPalette.allPalettes[0],
        finalMessage: "दीपावली की शुभकामनाएं - Wishing you prosperity",
