...
struct HoliDesignView: View, CulturalDesignViewProtocol {
    ...
    @StateObject private var chineseNewYearAI = HoliAIService.shared
    ...
    private func generateHoliGift() {
        ...
        Task {
            do {
                ...
                let iPhoneResult = try await chineseNewYearAI.generateHoliGift(
                    theme: selectedTheme!,
                ...
                let watchResult = try await chineseNewYearAI.generateHoliGift(
                    theme: selectedTheme!,
                    element: selectedElement,
                    colorPalette: selectedColorPalette!,
                    message: "", // No text in AI - will overlay natively
