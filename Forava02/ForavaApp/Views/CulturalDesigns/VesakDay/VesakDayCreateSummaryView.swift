...
struct VesakDayCreateSummaryView: View {
    ...
    private func generationPreview() -> some View {
        VStack(spacing: 12) {
            ...
            Text("Your personalized Vesak Day gift will include both iPhone and Apple Watch formats")
...
#Preview {
    VesakDayCreateSummaryView(
        ...
        selectedElements: [VesakDayElement.allElements[0]],
        selectedColorPalette: VesakDayColorPalette.allPalettes[0],
        finalMessage: "May the Buddha's teachings bring you peace and wisdom",
