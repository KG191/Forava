...
struct VesakDaySendShareView: View {
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Send your personalized Vesak Day gift to \(selectedContact.name)")
...
struct MessageComposeView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> MFMessageComposeViewController {
        ...
        if let imageData = image.jpegData(compressionQuality: 0.9) {
            controller.addAttachmentData(imageData, typeIdentifier: "public.jpeg", filename: "vesakday-gift.jpg")
        }
