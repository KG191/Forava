...
struct VesakDayCheckImageView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                // Header Section
                VStack(spacing: 12) {
                    Text(isGenerating ? "Generating Your Gift..." : "Your Vesak Day Gift")
    ...
    private func generationProgress() -> some View {
        VStack(spacing: 20) {
            ...
            Text("Creating your personalized Vesak Day gift...")
        ...
        NavigationView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Generate a new variation of your Vesak Day design")
                        .font(.system(.body, design: .rounded))
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                }
    ...
    private func emptyState() -> some View {
        VStack(spacing: 16) {
            ...
            Text("Go to the Create tab to generate your Vesak Day gift")
                .font(.system(.subheadline, design: .rounded))
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
        }
...
#Preview {
    VesakDayCheckImageView(
        generatedImages: [:],
        personalMessage: "May the Buddha's teachings bring you peace",
