...
struct VesakDayColorPaletteView: View {
    @Binding var selectedColorPalette: VesakDayColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Vesak Day celebration")
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: VesakDayColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: VesakDayColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    VesakDayColorPaletteView(
        selectedColorPalette: .constant(VesakDayColorPalette.allPalettes[0]),
