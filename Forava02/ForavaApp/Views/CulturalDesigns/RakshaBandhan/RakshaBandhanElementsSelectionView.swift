...
struct RakshaBandhanElementsSelectionView: View {
    @Binding var selectedElements: [RakshaBandhanElement]
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        LazyVGrid(columns: columns, spacing: 12) {
                            ForEach(RakshaBandhanElement.allElements) { element in
                                elementCard(
                                    element: element,
    ...
    private func toggleElementSelection(_ element: RakshaBandhanElement) {
...
#Preview {
    RakshaBandhanElementsSelectionView(
        selectedElements: .constant([RakshaBandhanElement.allElements[0]]),
