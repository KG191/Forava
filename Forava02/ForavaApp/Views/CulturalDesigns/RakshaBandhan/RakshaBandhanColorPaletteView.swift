...
struct RakshaBandhanColorPaletteView: View {
    @Binding var selectedColorPalette: RakshaBandhanColorPalette?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Select colors that will set the perfect mood for your Raksha Bandhan celebration")
                ...
                VStack(spacing: 20) {
                    LazyVGrid(columns: columns, spacing: 16) {
                        ForEach(RakshaBandhanColorPalette.allPalettes) { palette in
                            colorPaletteCard(
                                palette: palette,
    ...
    @ViewBuilder
    private func colorPaletteCard(palette: RakshaBandhanColorPalette, isSelected: Bool) -> some View {
        Button {
    ...
    @ViewBuilder
    private func selectedPalettePreview(palette: RakshaBandhanColorPalette) -> some View {
        VStack(spacing: 16) {
...
#Preview {
    RakshaBandhanColorPaletteView(
        selectedColorPalette: .constant(RakshaBandhanColorPalette.allPalettes[0]),
