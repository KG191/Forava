...
struct RakshaBandhanPersonalTouchView: View {
    @Binding var selectedMessage: RakshaBandhanPersonalTouch?
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Choose a message or write your own Raksha Bandhan greeting")
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        ForEach(RakshaBandhanPersonalTouch.optionalMessages) { message in
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("\(personalMessage.count)/\(RakshaBandhanPersonalTouch.maxPersonalMessageLength)")
    ...
    @ViewBuilder
    private func messageCard(message: RakshaBandhanPersonalTouch) -> some View {
        Button {
...
#Preview {
    RakshaBandhanPersonalTouchView(
        selectedMessage: .constant(RakshaBandhanPersonalTouch.optionalMessages[0]),
