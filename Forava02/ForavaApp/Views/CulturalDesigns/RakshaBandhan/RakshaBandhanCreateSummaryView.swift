...
struct RakshaBandhanCreateSummaryView: View {
    let selectedTheme: RakshaBandhanTheme?
    let selectedElements: [RakshaBandhanElement]
    let selectedColorPalette: RakshaBandhanColorPalette?
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                // Header Section
                VStack(spacing: 12) {
                    Text("Create Your Raksha Bandhan Gift")
    ...
    private func generationPreview() -> some View {
        VStack(spacing: 12) {
            ...
            Text("Your personalized Raksha Bandhan gift will include both iPhone and Apple Watch formats")
...
#Preview {
    RakshaBandhanCreateSummaryView(
        ...
        selectedElements: [RakshaBandhanElement.allElements[0]],
        selectedColorPalette: RakshaBandhanColorPalette.allPalettes[0],
        finalMessage: "रक्षा बंधन की शुभकामनाएं - Wishing you prosperity",
