...
struct AnniversaryTestSuite {
    ...
    private static func generateBaselineTests() -> [TestCase] {
        ...
        for theme in AnniversaryTheme.allCases {
            let giftOption = theme.giftOptions[0]

            // Test with each centre piece individually
            for centrePiece in AnniversaryElement.centrePieces {
    ...
    private static func generateGiftOptionTests() -> [TestCase] {
        var tests: [TestCase] = []
        let defaultElement = AnniversaryElement.centrePieces[0]  // Hearts
        let defaultColor = AnniversaryColorPalette.allPalettes[0]  // Classic Romance

        for theme in AnniversaryTheme.allCases {
            for (index, giftOption) in theme.giftOptions.enumerated() {
                tests.append(TestCase(
    ...
    private static func generateElementCombinationTests() -> [TestCase] {
        ...
        let defaultGift = defaultTheme.giftOptions[0]
        ...
        for centrePiece in AnniversaryElement.centrePieces {
            for supportingElement in AnniversaryElement.supportingElements {
                tests.append(TestCase(
        ...
        let complexCombinations: [[AnniversaryElement]] = [
            ...
            [AnniversaryElement.centrePieces[0],  // Hearts
             AnniversaryElement.supportingElements[0],  // Flowers
             AnniversaryElement.supportingElements[1]],  // Champagne

            [AnniversaryElement.centrePieces[0],  // Hearts
             AnniversaryElement.supportingElements[2],  // Confetti
             AnniversaryElement.supportingElements[3]],  // Ribbon

            // Rings + multiple supports
            [AnniversaryElement.centrePieces[1],  // Rings
             AnniversaryElement.supportingElements[0],  // Flowers
             AnniversaryElement.supportingElements[2]],  // Confetti
            ...
            [AnniversaryElement.centrePieces[2],  // Calendar
             AnniversaryElement.supportingElements[0],  // Flowers
             AnniversaryElement.supportingElements[3]],  // Ribbon

            // Trophy + multiple supports
            [AnniversaryElement.centrePieces[3],  // Trophy
             AnniversaryElement.supportingElements[1],  // Champagne
             AnniversaryElement.supportingElements[2]],  // Confetti
        ...
        let multiCentreCombinations: [[AnniversaryElement]] = [
            [AnniversaryElement.centrePieces[0], AnniversaryElement.centrePieces[1]],  // Hearts + Rings
            [AnniversaryElement.centrePieces[0], AnniversaryElement.centrePieces[2]],  // Hearts + Calendar
            [AnniversaryElement.centrePieces[1], AnniversaryElement.centrePieces[2]],  // Rings + Calendar
            [AnniversaryElement.centrePieces[2], AnniversaryElement.centrePieces[3]],  // Calendar + Trophy
            [AnniversaryElement.centrePieces[0], AnniversaryElement.centrePieces[1],
             AnniversaryElement.supportingElements[0]],  // Hearts + Rings + Flowers
            [AnniversaryElement.centrePieces[1], AnniversaryElement.centrePieces[3],
             AnniversaryElement.supportingElements[1]],  // Rings + Trophy + Champagne
            [AnniversaryElement.centrePieces[0], AnniversaryElement.centrePieces[2],
             AnniversaryElement.supportingElements[2]],  // Hearts + Calendar + Confetti
            [AnniversaryElement.centrePieces[0], AnniversaryElement.centrePieces[1],
             AnniversaryElement.centrePieces[2]]  // 3 centre pieces
        ]
    ...
    private static func generateColorValidationTests() -> [TestCase] {
        ...
        for colorPalette in AnniversaryColorPalette.allPalettes {
            for theme in AnniversaryTheme.allCases {
                let giftOption = defaultGiftOptions[theme] ?? theme.giftOptions[0]
    ...
    private static func generateCrossTabIntegrationTests() -> [TestCase] {
        ...
        let integrationScenarios: [(theme: AnniversaryTheme, gift: String, elements: [AnniversaryElement], color: String)] = [
            // Romantic scenarios
            (.romantic, "Classic Love Letter Card", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Classic Romance"),
            (.romantic, "Romantic Garden Scene", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Soft Pastels"),
            (.romantic, "Elegant Couple Silhouette", [AnniversaryElement.centrePieces[1], AnniversaryElement.supportingElements[0]], "Ruby Passion"),
            (.romantic, "Heart Constellation Design", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[2]], "Elegant Black"),
            (.romantic, "Vintage Romance Card", [AnniversaryElement.centrePieces[1], AnniversaryElement.supportingElements[3]], "Vintage Love"),
            (.romantic, "Modern Love Typography", [AnniversaryElement.centrePieces[0]], "Modern Minimalist"),
            (.romantic, "Sunset Together Scene", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Classic Romance"),
            (.romantic, "Love Story Timeline", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[3]], "Soft Pastels"),

            // Milestone scenarios
            (.milestone, "Golden Years Celebration", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1]], "Golden Years"),
            (.milestone, "Milestone Number Design", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[2]], "Golden Years"),
            (.milestone, "Achievement Timeline Card", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[3]], "Silver Celebration"),
            (.milestone, "Memory Collage Style", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Vintage Love"),
            (.milestone, "Progress Journey Map", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[1]], "Golden Years"),
            (.milestone, "Celebration Fireworks", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[2]], "Golden Years"),
            (.milestone, "Trophy Achievement Card", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1]], "Golden Years"),
            (.milestone, "Success Story Design", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[2]], "Silver Celebration"),

            // Family scenarios
            (.family, "Family Tree Design", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Vintage Love"),
            (.family, "Generational Legacy Card", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[3]], "Golden Years"),
            (.family, "Family Photo Mosaic", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Soft Pastels"),
            (.family, "Home & Hearts Theme", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Classic Romance"),
            (.family, "Family Crest Style", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[3]], "Elegant Black"),
            (.family, "Heritage Celebration", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Vintage Love"),
            (.family, "Unity Symbol Design", [AnniversaryElement.centrePieces[1], AnniversaryElement.supportingElements[3]], "Golden Years"),
            (.family, "Family Bond Circle", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Soft Pastels"),

            // Achievement scenarios
            (.achievement, "Career Milestone Card", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1]], "Silver Celebration"),
            (.achievement, "Educational Achievement", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[2]], "Golden Years"),
            (.achievement, "Personal Growth Journey", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Soft Pastels"),
            (.achievement, "Success Story Design", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[2]], "Golden Years"),
            (.achievement, "Professional Recognition", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1]], "Elegant Black"),
            (.achievement, "Goal Achievement Theme", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[2]], "Golden Years"),
            (.achievement, "Excellence Award Style", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[3]], "Silver Celebration"),
            (.achievement, "Accomplishment Timeline", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[1]], "Golden Years"),

            // Complex multi-element scenarios
            (.romantic, "Classic Love Letter Card", [
                AnniversaryElement.centrePieces[0],
                AnniversaryElement.centrePieces[1],
                AnniversaryElement.supportingElements[0]
            ], "Classic Romance"),

            (.milestone, "Golden Years Celebration", [
                AnniversaryElement.centrePieces[3],
                AnniversaryElement.supportingElements[1],
                AnniversaryElement.supportingElements[2]
            ], "Golden Years"),

            (.family, "Family Tree Design", [
                AnniversaryElement.centrePieces[0],
                AnniversaryElement.supportingElements[0],
                AnniversaryElement.supportingElements[3]
            ], "Vintage Love"),
    ...
    private static func generateEdgeCaseTests() -> [TestCase] {
        ...
        tests.append(TestCase(
            ...
            elements: [AnniversaryElement.centrePieces[0]],
            colorPalette: AnniversaryColorPalette.allPalettes.first(where: { $0.name == "Elegant Black" })!,
        ...
        tests.append(TestCase(
            ...
            theme: .romantic,
            giftOption: "Classic Love Letter Card",
            elements: AnniversaryElement.centrePieces,  // All 4 centre pieces
        ...
        tests.append(TestCase(
            ...
            theme: .romantic,
            giftOption: "Classic Love Letter Card",
            elements: AnniversaryElement.supportingElements,  // Only supporting
            colorPalette: AnniversaryColorPalette.allPalettes[0],
        ...
        let challengingCombinations: [(theme: AnniversaryTheme, gift: String, color: String)] = [
            (.romantic, "Modern Love Typography", "Elegant Black"),
            (.romantic, "Heart Constellation Design", "Silver Celebration"),
            (.milestone, "Achievement Timeline Card", "Vintage Love"),
            (.family, "Family Crest Style", "Modern Minimalist"),
            (.achievement, "Personal Growth Journey", "Soft Pastels"),
            (.romantic, "Vintage Romance Card", "Modern Minimalist"),
            (.milestone, "Celebration Fireworks", "Elegant Black"),
            (.family, "Unity Symbol Design", "Silver Celebration"),
            (.achievement, "Excellence Award Style", "Soft Pastels"),
            (.romantic, "Sunset Together Scene", "Silver Celebration"),
            (.milestone, "Memory Collage Style", "Modern Minimalist"),
            (.family, "Heritage Celebration", "Elegant Black"),
            (.achievement, "Accomplishment Timeline", "Vintage Love"),
            (.romantic, "Elegant Couple Silhouette", "Modern Minimalist"),
            (.milestone, "Progress Journey Map", "Soft Pastels"),
            (.family, "Generational Legacy Card", "Silver Celebration"),
            (.achievement, "Goal Achievement Theme", "Vintage Love"),
            (.romantic, "Love Story Timeline", "Elegant Black"),
            (.milestone, "Trophy Achievement Card", "Modern Minimalist"),
        ...
        for (index, combo) in challengingCombinations.enumerated() {
            ...
            tests.append(TestCase(
                ...
                elements: [AnniversaryElement.centrePieces[0]],  // Hearts as default
                colorPalette: colorPalette,
    ...
    private static func generateUserJourneyTests() -> [TestCase] {
        ...
        let romanticJourneySteps: [(gift: String, elements: [AnniversaryElement], color: String)] = [
            ("Classic Love Letter Card", [AnniversaryElement.centrePieces[0]], "Classic Romance"),
            ("Romantic Garden Scene", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Soft Pastels"),
            ("Elegant Couple Silhouette", [AnniversaryElement.centrePieces[1], AnniversaryElement.supportingElements[0]], "Ruby Passion")
        ]
        ...
        let milestoneJourneySteps: [(gift: String, elements: [AnniversaryElement], color: String)] = [
            ("Golden Years Celebration", [AnniversaryElement.centrePieces[3]], "Golden Years"),
            ("Achievement Timeline Card", [AnniversaryElement.centrePieces[2], AnniversaryElement.supportingElements[1]], "Golden Years"),
            ("Celebration Fireworks", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1], AnniversaryElement.supportingElements[2]], "Golden Years")
        ]
        ...
        let familyJourneySteps: [(gift: String, elements: [AnniversaryElement], color: String)] = [
            ("Family Tree Design", [AnniversaryElement.centrePieces[0]], "Vintage Love"),
            ("Home & Hearts Theme", [AnniversaryElement.centrePieces[0], AnniversaryElement.supportingElements[0]], "Classic Romance"),
            ("Family Bond Circle", [AnniversaryElement.centrePieces[0], AnniversaryElement.centrePieces[1], AnniversaryElement.supportingElements[0]], "Soft Pastels")
        ]
        ...
        let achievementJourneySteps: [(gift: String, elements: [AnniversaryElement], color: String)] = [
            ("Career Milestone Card", [AnniversaryElement.centrePieces[3]], "Silver Celebration"),
            ("Professional Recognition", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1]], "Elegant Black"),
            ("Success Story Design", [AnniversaryElement.centrePieces[3], AnniversaryElement.supportingElements[1], AnniversaryElement.supportingElements[2]], "Golden Years")
        ]
