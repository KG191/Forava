...
// MARK: - Eid al-Fitr Selection State
struct EidAlFitrSelectionState: Codable {
    var selectedTheme: EidAlFitrTheme?
    var selectedGift: String?
    var selectedElements: [EidAlFitrElement] = []
    var selectedColorPalette: EidAlFitrColorPalette?
    var selectedOptionalMessage: EidAlFitrPersonalTouch?
